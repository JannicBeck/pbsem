...
#diagram zoo model
pathDiagram(PB_model_zoo, file = "PB-structure-zoo", edge.labels = "both",
           output.type = "graphics", digits = 4, rSquared=rSquared(PB_model_zoo))
...
<<>>=
CB_data_F<- subset(CB_data, F040 == "F")
CB_data_M<- subset(CB_data, F040 == "M")
@
